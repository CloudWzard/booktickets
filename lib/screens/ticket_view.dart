...
class TicketView extends StatelessWidget {
  ...
  final bool? isColor;
   const TicketView({Key? key, required this.ticket, required
        ...
        child: Column(
          ...
          children: [
           ...
           // showing the blue part of the ticket
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            SizedBox(
                              width: AppLayout.getWidth(100),
                              child: Text(
                                ticket['to']['name'], textAlign:TextAlign.end,style: isColor==null?Styles.headLineStyle4.copyWith(color: Colors.white):Styles.headLineStyle4,
                              ),
                            ),
                          ],
                        )
            ...
            Container( color: isColor==null?Styles.orangeColor:Colors.white,
            child:Row(
                children: [
                  SizedBox(
